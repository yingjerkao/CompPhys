...
\begin{enumerate}
\item Implement a \verb!Base! class such that it will take the trajectory data of a moving object and approximate it with a polynomial of degree 3 using curve fitting. 
\item 
\end{enumerate}
Hand-In Procedure  
\begin{enumerate}
\item Save your code as py12.py.
